...
Status: complete. Model 1 uses Nemotron and Model 2 uses GPT-OSS through the shared
NVIDIA credential. Reliability and exact-usage tests cover both routes.
