...
async def main():
    ...
    selected_indices = [
        0, 2, 4, 9, 24,         # Phase 1: Ledger Configuration
        25, 27, 29, 34, 49,     # Phase 2: Kubernetes Deployment
        50, 53, 56, 59, 74,     # Phase 3: Smart Fridge & Coffee Noise
        75, 76, 77, 79, 99      # Phase 4: Hybrid Synthesis & Compaction
    ]
    ...
    for idx, prompt in enumerate(prompts, 1):
        ...
        try:
            ...
            print(f"  [SC-EVM] Completed in {engine_metrics['total_latency']:.2f}s | Context: {engine_metrics['input_context_tokens']} tokens.")
        ...
        try:
            ...
            print(f"  [Baseline] Completed in {baseline_metrics['total_latency']:.2f}s | Context: {baseline_metrics['input_context_tokens']} tokens.")
        except Exception as e:
