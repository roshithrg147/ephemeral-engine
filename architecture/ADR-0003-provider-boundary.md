...
The current implementation supports NVIDIA NIM only. Qwen and Kimi identifiers are configurable, but their logical roles in reformulation, candidate reasoning, and synthesis are code-defined. Local ONNX MiniLM supplies embeddings. Vertex AI, Anthropic, and other direct adapters are unsupported.
